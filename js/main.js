    ...
    $('#fullpage').fullpage({
        ...
        afterLoad: function (java1, index) {
            if(index >= 2 ){
                ...
                $('header .inner .header-img a img').attr({ src: "../images/logo_balck.svg" })
                $('.right-icon a > img').attr({src : '../images/right_black.svg'})
                $('.gotop').css({
                    height : '64'
                })
                ...
                $('header .inner .header-img a img').attr({ src: "../images/logo_wihte.svg" })
                $('.right-icon a > img').attr({src : '../images/right_wihte.svg'})
